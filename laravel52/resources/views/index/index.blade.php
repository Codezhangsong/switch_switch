...
<head>
	...
	<link rel="shortcut icon" href="{{asset('assets_index/assets/images/gt_favicon.png')}}">
	
	<!-- Bootstrap -->
	<link href="{{asset('assets_admin_login/bootstrap/css/bootstrap.css')}}" rel="stylesheet">
	<link href="{{asset('assets_index/assets/css/styles.css')}}" rel="stylesheet">
	<!-- Icons -->
	<!-- <link href="http://netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css" rel="stylesheet"> -->
	<!-- Fonts -->
	<link rel="stylesheet" href="http://fonts.googleapis.com/css?family=Alice|Open+Sans:400,300,700">
	<!-- Custom styles -->
	<!-- <link rel="stylesheet" href="{{asset('assets_index/assets/css/styles.css')}}"> -->

	<!--[if lt IE 9]> <script src="assets_index/assets/js/html5shiv.js"></script> <![endif]-->
</head>
<body class="home">
...
<header id="header">
	<div id="head" class="parallax" parallax-speed="2">
		<h1 id="logo" class="text-center">
			<img class="img-circle" src="{{asset('assets_index/assets/images/guy.jpg')}}" alt="">
...
<main id="main">
	...
	<div class="container">
			...
			<div class="thumbnails recentworks row">
				...
				<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
					<a class="thumbnail" href="sidebar-right.html">
						<span class="img">
							<img src="{{asset('assets_index/assets/images/s1.jpg')}}" alt="">
		...
		<div class="row section topspace">
			<div class="panel panel-cta"><div class="panel-body">
				...
				<div class="col-lg-4 text-right">
					<a href="#/downloads/initio.zip " class="btn btn-primary btn-lg">Download template</a>
				</div>
			</div></div>
		</div> <!-- /section -->
		...
		<div class="row section clients topspace">
			...
			<div class="col-lg-12">
				<p>
					<img src="{{asset('assets_index/assets/images/sample_clients.png')}}" alt="">
				</p>
			</div>
		</div> <!-- /section -->
...
<script src="{{asset('assets_index/assets/js/jquery.min.js')}}"></script>
<script src="http://netdna.bootstrapcdn.com/bootstrap/3.0.0/js/bootstrap.min.js"></script>
<script src="{{asset('assets_index/assets/js/template.js')}}"></script>
</body>
</html>
